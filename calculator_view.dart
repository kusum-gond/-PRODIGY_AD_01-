...
class _CalculatorViewState extends State<CalculatorView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        backgroundColor: const Color.fromARGB(137, 243, 236, 236),
        appBar: AppBar(
          elevation: 0,
          backgroundColor: const Color.fromARGB(137, 207, 184, 184),
          leading: const Icon(Icons.settings,
              color: Color.fromARGB(255, 145, 20, 124)),
          actions: const [
            Padding(
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          const Icon(Icons.more_vert,
                              color: Color.fromARGB(255, 189, 54, 144),
                              size: 30),
...
//mainAxisAlignment: MainAxisAlignment.spaceAround
                  ...
                  calcButton('=', Color.fromARGB(255, 94, 92, 89),
                      () => buttonPressed('=')),
                ],
              )
            ],
